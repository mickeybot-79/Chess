        ...
        for (let i = 0; i < allPossibleMoves[blackPiece].length; i++) {
            ...
            if (Object.values(allPiecePositions).includes(currentCell)) {
                ...
                if (targetPiece.split('-')[1] !== 'black') {
                    if (targetPiece.split('-')[0] === 'pawn') currentCellValue += 1
                    if (targetPiece.split('-')[0] === 'bishop') currentCellValue += 2
                    if (targetPiece.split('-')[0] === 'knight') currentCellValue += 3
                    if (targetPiece.split('-')[0] === 'rook') currentCellValue += 4
                    if (targetPiece.split('-')[0] === 'queen') currentCellValue += 5
                    if (targetPiece.split('-')[0] === 'king') currentCellValue += 10
