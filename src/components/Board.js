...
const Board = () => {
    ...
    useEffect(() => {
        ...
        let isCheck = false
        const checkThreatVerify = (i, currentPiece, pieceMoves) => {
        ...
        for (let i = 0; i < Object.values(allPiecePositions).length; i++) {
            ...
            if (currentPosition !== -1) {
                ...
                if (currentPiece.indexOf('pawn') !== -1) {
                    ...
                    checkThreatVerify(i, currentPiece, pawnMoves)
                }
